			...
			<section id="main" class="wrapper">
				<div class="container">
					...
					<header class="major special">
						<h2>Catálogo</h2>
						<p> Lista de nuestros productos</p>
					</header>
					<div>
						<p>
							<a href="">Nuevo</a>	   
						...
						<table>
							...
							<?php
							 ...
							 while($row=$resultado->fetch_assoc())
							 {
								 ...
								 <td align="center"><a href=""><img src="images/Editar.png" align="EDIT" /></a></td>
								 <td align="center"><a href=""><img src="images/Cancelar.png" align="EDIT" /></a></td>
								 </tr>
								 <?php
							 }
							?>
